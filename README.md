...
> Άνοιγμα αυτής της σελίδας στο [https://meniaole.github.io/emotions/](https://meniaole.github.io/emotions/)
...
* αναζήτηση για **https://github.com/meniaole/emotions** και εισαγωγή

## Επεξεργασία αυτού του έργου ![Σήμα κατάστασης κατασκευής](https://github.com/meniaole/emotions/workflows/MakeCode/badge.svg)

Για επεξεργασία αυτού του αποθετηρίου στο MakeCode.

* άνοιγμα [https://makecode.microbit.org/](https://makecode.microbit.org/)
* κάντε κλικ στην **Εισαγωγή** και έπειτα στην **Εισαγωγή διεύθυνσης URL**
* επικολλήστε **https://github.com/meniaole/emotions** και κάντε κλικ στην εισαγωγή
...
![Προβολή απόδοσης των μπλοκ](https://github.com/meniaole/emotions/raw/master/.github/makecode/blocks.png)
